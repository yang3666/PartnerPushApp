...
public class CalendarUtil {
    ...
    public static String lunarToSolar(String lunarDate, boolean leapMonthFlag) throws Exception{
        ...
        log.info("阳历日期为："+formatter.format(myDate));
     ...
     * @throws Exception
     */
    public static String getBirth(String aimDate) throws Exception {
        Date date = new Date();
        SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");
        String format = formatter.format(date);
        String s = CalendarUtil.solarToLunar(format);
        String concat = s.substring(0, 4).concat(aimDate.substring(4));
        String birth = CalendarUtil.lunarToSolar(concat, false);
        return birth;
    }
